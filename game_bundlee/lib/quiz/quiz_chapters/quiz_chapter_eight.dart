...
import 'package:game_bundlee/quiz/quiz_result_page.dart';

import '../quiz_Models/quiz_question_model.dart';
import 'package:flutter/material.dart';

class ChapterEight extends StatefulWidget {
  const ChapterEight({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          SizedBox(
            height: 300,
            width: 350,
            child: Image.asset(QuizQuestionModel.chapterEight.questions[currentIndex].image),
          ),
          Expanded(
